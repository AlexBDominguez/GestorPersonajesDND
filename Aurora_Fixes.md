...
- **(2026-06-19) Sugerencia de UX pendiente:** en modo edición, cada paso del wizard debería mostrar "Save Changes" en vez de "Next" (no solo el último paso), para poder guardar tras cambiar un solo campo sin pasar por todos los pasos.
