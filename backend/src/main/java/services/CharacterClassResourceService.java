...
public class CharacterClassResourceService {
    ...
    // Delegado a CharacterFormulaService (compartido con NumericBonusService, #8.2 NUMERIC_BONUS)
    // desde que dejó de ser una DSL exclusiva de recursos.
    private int calculateMaxAmount(PlayerCharacter character, ClassResource resource) {
        return formulaService.evaluate(character, resource.getMaxFormula());
    }
